...
//
// Only one real consumer today (MatrixActionsReference), same bet
// buildSkillPool made when it started out colocated with SkillRow —
// nothing stops Combat or a retrofitted SkillRow importing this
// directly once a second consumer actually needs it.
