...
import { GEAR_FIREARMS_EXPLOSIVES as g, AMMO_TYPES, EXPLOSIVE_RATING_BANDS, MISSILE_VARIANT_MODIFIER } from '@data/gear/firearms_explosives';
...
export default function GearFirearmsExplosives() {
  return (
    <>
